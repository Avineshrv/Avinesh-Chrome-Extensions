  ...
  return (
    <header id="control-bar">
              ...
              <div className="custom-dropdown-menu">
                {filteredDevices.map(([key, cfg]) => (
                  ...
                  >
                    ...
                    <span className="item-name">{cfg.name}</span>
      ...
      <div className="url-bar">
        <button className="nav-btn" onClick={() => onNav('back')} title="Back">
        ...
        <button className="nav-btn" onClick={() => onNav('forward')} title="Forward">
          <svg viewBox="0 0 640 640" width="14" height="14" fill="currentColor" style={{ display: 'inline-block', verticalAlign: 'middle', transform: 'rotate(-90deg)', transformOrigin: 'center' }}>
            <path d="M297.4 438.6C309.9 451.1 330.2 451.1 342.7 438.6L502.7 278.6C515.2 266.1 515.2 245.8 502.7 233.3C490.2 220.8 469.9 220.8 457.4 233.3L320 370.7L182.6 233.4C170.1 220.9 149.8 220.9 137.3 233.4C124.8 245.9 124.8 266.2 137.3 278.7L297.3 438.7z"/>
          </svg>
        </button>
        <button className="nav-btn" onClick={() => onNav('refresh')} title="Refresh">
